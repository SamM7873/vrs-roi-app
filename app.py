...
t2_support_page = st.Page("pages/49_T2_Support.py",                       title="T2 Support",                   icon="🛠️")
...
_nav = {
    ...
    "Support": [cs_tickets_page, ticket_rpt_page, jira_rpt_page, survey_page, ivt_page, ticket_pipe_page, convo_greet_page, t2_support_page],
